    ...
    <section className="min-h-screen flex flex-col justify-between relative px-8 md:px-16 pt-32 pb-16 overflow-hidden bg-[#100E0E]">
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <motion.p
          ...
          className="text-[#FFFBFB]/60 max-w-md font-normal"
        ...
        >
          <a
            href="#proyectos"
            className="group inline-flex items-center gap-2 text-[#FFFBFB] text-sm font-normal transition-all duration-300 hover:gap-3"
          >
            Nuestros Proyectos
